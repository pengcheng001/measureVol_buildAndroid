...
LOCAL_SRC_FILES := pmdlibs/arm64-v8a/libusb1.0.so
else
LOCAL_SRC_FILES := pmdlibs/armeabi-v7a/libusb1.0.so
endif
...
LOCAL_MODULE := Tof
ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
LOCAL_SRC_FILES := pmdlibs/arm64-v8a/libTof.so
#NDK_APP_DST_DIR := ../libs/arm64-v8a/
else
LOCAL_SRC_FILES := pmdlibs/armeabi-v7a/libTof.so
